...
enum Choice { choice1, choice2 }

class StoryTeller {
  final List<Story> _storyData = const [
    Story(
        storyTitle:
            'Your car has blown a tire on a winding road in the middle of nowhere with no cell phone reception. You decide to hitch-hike. A rusty pickup truck rumbles to a stop next to you. A man with a wide brimmed hat with soulless eyes opens the passenger door for you and asks: "Need a ride, boy?".',
  ...
  bool showChoice1() => getChoice1().isNotEmpty;
  bool showChoice2() => getChoice2().isNotEmpty;
